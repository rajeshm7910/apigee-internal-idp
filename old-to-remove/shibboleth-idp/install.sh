...
curl -o /opt/apigee/shibboleth-identity-provider-3.4.0.tar.gz https://shibboleth.net/downloads/identity-provider/3.4.0/shibboleth-identity-provider-3.4.0.tar.gz
